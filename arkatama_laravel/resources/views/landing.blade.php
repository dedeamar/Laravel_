...
<style>
    ...
    background-color:rgb(217, 237, 244);
            ...
            * {
            ...
            .banner {
                background-color: #285278;
                height: 60vh;
                background-image: url('C:\laragon\www\arkatama_laravel\resources\css\image\7n.jpg');
            ...
            .foto {border: 1px solid #285278; margin:10px;}
	...
	<header>
		<div class="container">
			<h1><a href="index.html">Toko Seni</a></h1>
			<ul>
				<li class="active"><a href="index.html">HOME</a></li>
				<li><a class="nav-link" href="{{ url('/produk') }}">Dashboard</a></li>
	...
	<section class="banner">
		<h2><a href="....">WELCOME TO MY TOKO</a></h2>
	</section>
